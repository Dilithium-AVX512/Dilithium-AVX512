...
CFLAGS += -Wall -Wextra -Wpedantic -Wmissing-prototypes -Wredundant-decls \
  -Wshadow -Wpointer-arith -mavx512f -mavx512bw -mavx512cd -mavx512vl -mavx512dq -mavx2 -mpopcnt -maes \
...
KECCAK_SOURCES = $(SOURCES) fips202.c fips202x8.c keccak8x/KeccakP-1600-times8-SIMD512.c symmetric-shake.c
...
test/test_keygen2: test/test_keygen.c randombytes.c $(KECCAK_SOURCES) \
  $(KECCAK_HEADERS)
	$(CC) $(CFLAGS) -DDILITHIUM_MODE=2 \
	  -o $@ $< randombytes.c $(KECCAK_SOURCES)


test/test_sign2: test/test_sign.c randombytes.c $(KECCAK_SOURCES) \
  $(KECCAK_HEADERS)
	$(CC) $(CFLAGS) -DDILITHIUM_MODE=2 \
	  -o $@ $< randombytes.c $(KECCAK_SOURCES)
...
clean:
	...
	rm -f test/test_keygen2
	rm -f test/test_sign2
