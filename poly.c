...
void poly_reduce(poly *a)
{
  unsigned int i;
  __m256i f, g;
  const __m256i q = _mm256_load_si256(&qdata.vec[_16XQ / 8]);
...
void poly_invntt_tomont(poly *a)
{
  ...
  invntt_avx(a->vec512, qdata.vec512);
...
void poly_nttunpack(poly *a)
{
  ...
  nttunpack_avx(a->vec512, qdata.vec512);
...
void poly_pointwise_montgomery(poly *c, const poly *a, const poly *b)
{
  ...
  pointwise_avx(c->vec512, a->vec512, b->vec512, qdata.vec512);
...
void poly_power2round(poly *a1, poly *a0, const poly *a)
{
  ...
  power2round_avx(a1->vec512, a0->vec512, a->vec512);
...
void poly_decompose(poly *a1, poly *a0, const poly *a)
{
  ...
  decompose_avx(a1->vec512, a0->vec512, a->vec512);
...
unsigned int poly_make_hint(uint8_t hint[N], const poly *a0, const poly *a1)
{
  ...
  r = make_hint_avx(hint, a0->vec512, a1->vec512);
...
void poly_use_hint(poly *b, const poly *a, const poly *h)
{
  ...
  use_hint_avx(b->vec512, a->vec512, h->vec512);
...
void poly_uniform_preinit(poly *a, stream128_state *state)
{
  ...
  ALIGNED_UINT8(REJ_UNIFORM_BUFLEN + 8)
  buf;
                     ...
                     uint16_t nonce7)
{
  ...
  shake128x8_absorb_once(&state, buf[0].coeffs, buf[1].coeffs, buf[2].coeffs, buf[3].coeffs, buf[4].coeffs, buf[5].coeffs, buf[6].coeffs, buf[7].coeffs, SEEDBYTES + 2);
  shake128x8_squeezeblocks(buf[0].coeffs, buf[1].coeffs, buf[2].coeffs, buf[3].coeffs, buf[4].coeffs, buf[5].coeffs, buf[6].coeffs, buf[7].coeffs, REJ_UNIFORM_NBLOCKS, &state);
...
{
  unsigned int ctr;
  ALIGNED_UINT8(REJ_UNIFORM_ETA_BUFLEN)
  buf;
                         ...
                         uint16_t nonce7)
{
  ...
  _mm256_store_si256(&buf[4].vec[0], f);
  _mm256_store_si256(&buf[5].vec[0], f);
  _mm256_store_si256(&buf[6].vec[0], f);
  _mm256_store_si256(&buf[7].vec[0], f);
  ...
  _mm256_store_si256(&buf[4].vec[1], f);
  _mm256_store_si256(&buf[5].vec[1], f);
  _mm256_store_si256(&buf[6].vec[1], f);
  _mm256_store_si256(&buf[7].vec[1], f);
  ...
  shake256x8_absorb_once(&state, buf[0].coeffs, buf[1].coeffs, buf[2].coeffs, buf[3].coeffs, buf[4].coeffs, buf[5].coeffs, buf[6].coeffs, buf[7].coeffs, 66);
  shake256x8_squeezeblocks(buf[0].coeffs, buf[1].coeffs, buf[2].coeffs, buf[3].coeffs, buf[4].coeffs, buf[5].coeffs, buf[6].coeffs, buf[7].coeffs, REJ_UNIFORM_ETA_NBLOCKS, &state);
  ...
  while (ctr0 < N || ctr1 < N || ctr2 < N || ctr3 < N || ctr4 < N || ctr5 < N || ctr6 < N || ctr7 < N)
  {
    shake256x8_squeezeblocks(buf[0].coeffs, buf[1].coeffs, buf[2].coeffs, buf[3].coeffs, buf[4].coeffs, buf[5].coeffs, buf[6].coeffs, buf[7].coeffs, 1, &state);
                            ...
                            uint16_t nonce7)
{
  ...
  shake256x8_absorb_once(&state, buf[0].coeffs, buf[1].coeffs, buf[2].coeffs, buf[3].coeffs, buf[4].coeffs, buf[5].coeffs, buf[6].coeffs, buf[7].coeffs, 66);
  shake256x8_squeezeblocks(buf[0].coeffs, buf[1].coeffs, buf[2].coeffs, buf[3].coeffs, buf[4].coeffs, buf[5].coeffs, buf[6].coeffs, buf[7].coeffs, POLY_UNIFORM_GAMMA1_NBLOCKS, &state);
