...
#elif L == 4
    poly_uniform_eta_8x(&s.vec[0], &s.vec[1], &s.vec[2], &s.vec[3], &tmp, &tmp1, &tmp2, &tmp3, seed, 0, 1, 2, 3, 4, 5, 6, 7);
#elif L == 5
    poly_uniform_eta_8x(&s.vec[0], &s.vec[1], &s.vec[2], &s.vec[3], &s.vec[4], &tmp, &tmp1, &tmp2, seed, 0, 1, 2, 3, 4, 5, 6, 7);
#elif L == 7
    poly_uniform_eta_8x(&s.vec[0], &s.vec[1], &s.vec[2], &s.vec[3], &s.vec[4], &s.vec[5], &s.vec[6], &tmp, seed, 0, 1, 2, 3, 4, 5, 6, 7);
#else
#error
#endif
...
#elif L == 4
    poly_uniform_gamma1_8x(&y.vec[0], &y.vec[1], &y.vec[2], &y.vec[3], &tmp, &tmp1, &tmp2, &tmp3, seed, 0, 1, 2, 3, 4, 5, 6, 7);
#elif L == 5
    poly_uniform_gamma1_8x(&y.vec[0], &y.vec[1], &y.vec[2], &y.vec[3], &y.vec[4], &tmp, &tmp1, &tmp2, seed, 0, 1, 2, 3, 4, 5, 6, 7);
#elif L == 7
    poly_uniform_gamma1_8x(&y.vec[0], &y.vec[1], &y.vec[2], &y.vec[3], &y.vec[4], &y.vec[5], &y.vec[6], &tmp, seed, 0, 1, 2, 3, 4, 5, 6, 7);
#else
#error
#endif
    ...
    for (j = 0; j < N / 2; ++j)
    {
      ...
      if (tmp.coeffs[2 * j + 0] != w1.vec[0].coeffs[2 * j + 0] || tmp.coeffs[2 * j + 1] != w1.vec[0].coeffs[2 * j + 1])
