...
#define polyvec_matrix_expand_row0_1 DILITHIUM_NAMESPACE(polyvec_matrix_expand_row0_1)
void polyvec_matrix_expand_row0_1(polyvecl *rowa, polyvecl *rowb, polyvecl *rowc, const uint8_t rho[SEEDBYTES]);
#define polyvec_matrix_expand_row2_3 DILITHIUM_NAMESPACE(polyvec_matrix_expand_row2_3)
void polyvec_matrix_expand_row2_3(polyvecl *rowa, polyvecl *rowb, polyvecl *rowc, const uint8_t rho[SEEDBYTES]);
#define polyvec_matrix_expand_row4_5 DILITHIUM_NAMESPACE(polyvec_matrix_expand_row4_5)
void polyvec_matrix_expand_row4_5(polyvecl *rowa, polyvecl *rowb, polyvecl *rowc, const uint8_t rho[SEEDBYTES]);
#define polyvec_matrix_expand_row6_7 DILITHIUM_NAMESPACE(polyvec_matrix_expand_row6_7)
void polyvec_matrix_expand_row6_7(polyvecl *rowa, polyvecl *rowb, polyvecl *rowc, const uint8_t rho[SEEDBYTES]);
